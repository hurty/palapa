defmodule PalapaWeb.InvitationController do
  ...
  def new(conn, _params) do
    with :ok <- permit(Invitations, :create, current_member(conn)) do
  ...
  def delete(conn, %{"id" => id}) do
    ...
    with :ok <- permit(Invitations, :delete, current_member(conn), invitation),
  ...
  def renew(conn, %{"invitation_id" => invitation_id}) do
    ...
    with :ok <- permit(Invitations, :renew, current_member(conn), invitation),
         {:ok, new_invitation} <-
